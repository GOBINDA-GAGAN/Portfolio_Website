...
const SkillsCard = ({item, category}) => {
  return (
    ...
    <div className="  bg-[#1F1F1F] rounded-lg  w-[300px] max-h-[400px] h-[300px] border border-gray-500 shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] ">
